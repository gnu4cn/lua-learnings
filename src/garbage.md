...
这种工厂非常适合记忆化，避免了在已有闭包情况下，创建出新的闭包。下 [图 23.1 “带有记忆功能的恒定函数工厂”](#fig_23.1) 展示了这种改进。


<a name="fig_23.1"></a> 图 23.1，带有记忆术的常量函数工厂，constant-function factory with memorization
